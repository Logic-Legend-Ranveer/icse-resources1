    ...
    return (
      <div className="pl-1">
        <button
          ...
          className="flex items-center gap-1.5 w-full text-left py-1.5 px-1 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md text-sm font-medium text-slate-700 dark:text-slate-200 transition-colors cursor-pointer"
        >
  ...
  return (
    <div className="pl-1">
      <button
        ...
        className="flex items-center gap-1.5 w-full text-left py-1.5 px-1 ml-2 hover:bg-indigo-50 dark:hover:bg-indigo-950/60 hover:text-indigo-600 dark:hover:text-indigo-300 rounded-md text-sm text-slate-600 dark:text-slate-300 transition-colors cursor-pointer group"
      >
